<template>
  <div class="w-96 m-auto text-left">
    ...
    <p class="mt-5 text-sm">See also:</p>
    <ul>
      <li><a href="https://hopeful-lovelace-0427e2.netlify.app/">Spacer</a></li>
      <li><a href="https://gallant-albattani-4a9ed5.netlify.app/">Tictactoe</a></li>
    </ul>
  </div>
